			...
			<form action="" method="POST">
				<div class="form-group row ">
					...
					<div class="col-sm-4 push-sm-4">
						<input name="idTheLoai" type="text" class="form-control" id="inputEmail3" placeholder="Nhập ID thể loại Ví dụ Xã Hội ID là XH">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-2 col-form-label">Tên Thể Loại</label>
					<div class=" col-sm-4 push-sm-4">
						<input name="tenTheLoai" type="text" class="form-control" id="inputPassword3" placeholder="Tên Thể Loại">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-2 col-form-label">Thứ Tự</label>
					<div class=" col-sm-4 push-sm-4">
						<input name="thuTu" type="text" class="form-control" id="inputPassword3" placeholder="Tên Thể Loại">
					</div>
				</div>
				
				<div class="form-group row text-left">
					<div class="col-sm-10">
						<button name="action" value="addtheloai" type="submit" class="btn btn-primary">Thêm</button>
					</div>
				</div>
			</form>
		</div>
