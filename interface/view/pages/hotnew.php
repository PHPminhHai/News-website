<?php 
$layNhungTinXemNhieuNhat = TinchitietDB::layNhungTinXemNhieuNhat();
$sotinmottrang = 5;
$tongSoTin=count(TinchitietDB::layMuoiTinHotNhat());
...
$tinHotNhat_PhanTrang = TinchitietDB::tinHotNhat_PhanTrang($from, $sotinmottrang);
?>
<div class="col-sm-8">
	<div class="alert alert-primary p-1 pl-3 border-0" role="alert">
		<small class="p-0 text-capitalize">Tin Hot Nhất</small>
		<a href="" class="float-right pr-3"></a>
		<?php foreach ($tinHotNhat_PhanTrang as $key => $value):?>
		</div>
		<div class="card mb-3">
